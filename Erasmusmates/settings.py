"""
Django settings for Erasmusmates project.
...
SECRET_KEY = '+ru^-az!8_zi%ap1&a)ypvy!r9i3i8s^@+(=vc!*&bpt=(q%+@'
...
ROOT_URLCONF = 'Erasmusmates.urls'
...
WSGI_APPLICATION = 'Erasmusmates.wsgi.application'
